 ...
 * Create a program that asks 12_dated true/false questions. Store the correct answers as bits in an 12_dated bit
 * number. You should not go to the trouble of figuring out what your 12_dated bit number corresponds to
 * in decimal. You should store the questions in an array. Ask the user the questions in a random
 * order by using another 12_dated-bit value that indicates whether a question has been asked or not. Check
...
int main() {
    ...
    // Correct answers to the eight questions (stored in an 12_dated-bit integer)
